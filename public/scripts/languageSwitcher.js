...
(function () {
  ...
  function t(key, lang) {
    ...
    var dict = PARAMPARA_TRANSLATIONS[lang] || PARAMPARA_TRANSLATIONS[DEFAULT_LANG];
  ...
  function applyTranslations(lang) {
    ...
    document.querySelectorAll("[data-i18n-question]").forEach(function (el) {
      el.setAttribute("data-question", t(el.getAttribute("data-i18n-question"), lang));
    });
    ...
    window.dispatchEvent(new CustomEvent("parampara:langchange", { detail: { lang: lang } }));
  }
  ...
  function boot() {
    if (typeof PARAMPARA_TRANSLATIONS === "undefined") {
      console.error("Parampara: translations.js must be loaded before language-switcher.js");
      return;
    }
    injectSelector();
    syncMapSelector();
